...
copies declare the same twenty-six custom properties with the same values, and nothing keeps
them in step. Change one accent and the board looks correct until the first paint of the
next load.
